...
public class VendaController {
    ...
    BancoDeVendas bcoVendas = BancoDeVendas.getInstancia();
    BancoDeClientes bcoClientes = BancoDeClientes.getInstancia();
    BancoDeProdutos bcoProdutos = BancoDeProdutos.getInstancia();
